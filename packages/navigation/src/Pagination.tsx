    ...
    return (
      ...
      >
        <NavButton
          direction="prev"
          targetPage={page - 1}
          icon={<ChevronLeftIcon className={sizes.icon} />}
          label="Previous page"
        />
        ...
        <NavButton
          direction="next"
          targetPage={page + 1}
          icon={<ChevronRightIcon className={sizes.icon} />}
          label="Next page"
        />
      </nav>
    );
    ...
    >
      {showFirstLast && (
        <NavButton
          direction="first"
          targetPage={1}
          icon={<ChevronsLeftIcon className={sizes.icon} />}
          label="First page"
        />
      )}
      ...
      {showFirstLast && (
        <NavButton
          ...
          icon={<ChevronsRightIcon className={sizes.icon} />}
          label="Last page"
        />
      )}
    </nav>
