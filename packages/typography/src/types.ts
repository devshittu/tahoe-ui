 ...
 * All typography components use these shared types for consistency.
 */
...
export type InlineCodeProps = Omit<HTMLAttributes<HTMLElement>, 'children'> & {
  children: ReactNode;
  className?: string;
};
...
export type CaptionProps = Omit<HTMLAttributes<HTMLSpanElement>, 'children'> & {
  children: ReactNode;
  color?: TextColor | (string & {});
  className?: string;
};
...
export type LeadProps = TypographyBaseProps &
  Omit<HTMLAttributes<HTMLParagraphElement>, keyof TypographyBaseProps> & {
    margin?: string;
  };
...
export type SmallTextProps = TypographyBaseProps &
  Omit<HTMLAttributes<HTMLSpanElement>, keyof TypographyBaseProps>;

// ============ Hr Props ============

export type HrProps = Omit<HTMLAttributes<HTMLHRElement>, 'children'> & {
  className?: string;
};
