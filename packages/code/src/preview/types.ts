// packages/code/src/preview/types.ts
...
export const CODE_PREVIEW_STYLES = {
  container: {
    base: 'bg-bg-elevated/90 dark:bg-bg-elevated/90',
  ...
  header: {
    base: 'bg-bg-secondary/50 dark:bg-bg-tertiary/30',
    border: 'border-b border-border-subtle/60 dark:border-border-subtle/50',
    title: 'text-text-secondary dark:text-text-muted',
    badge:
      'bg-bg-secondary dark:bg-bg-tertiary text-text-muted dark:text-text-muted',
  },
  lineNumber: {
    base: 'text-text-muted dark:text-text-muted',
  },
  highlight: {
    bg: 'bg-brand-primary-500/10 dark:bg-brand-primary-500/15',
    border: 'border-l-2 border-brand-primary-500',
  },
  copyButton: {
    base: 'bg-bg-elevated/80 dark:bg-bg-tertiary/80',
    border: 'border border-border-subtle/50 dark:border-border-subtle/50',
    hover: 'hover:bg-bg-elevated dark:hover:bg-bg-secondary',
    icon: 'text-text-secondary dark:text-text-muted',
    success: 'bg-success/10 dark:bg-success/20 border-success/50',
    successIcon: 'text-success dark:text-success',
  },
  collapseToggle: {
    base: 'text-text-muted dark:text-text-muted',
    hover: 'hover:text-text-secondary dark:hover:text-text-secondary',
    icon: 'text-brand-primary-500 dark:text-brand-primary-400',
  },
  skeleton: {
