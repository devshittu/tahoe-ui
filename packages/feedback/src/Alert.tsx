...
const getAlertStyles = (variant: AlertVariant, color: FeedbackColor): string => {
  const styles: Record<AlertVariant, Record<FeedbackColor, string>> = {
    ...
    outlined: {
      default: 'border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300',
    ...
    soft: {
      ...
      success: 'bg-green-50 dark:bg-green-950 text-green-800 dark:text-green-300',
