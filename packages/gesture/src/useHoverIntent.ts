...
export interface UseHoverIntentOptions {
  /** Delay before triggering hover start (ms) @default 300 */
  openDelay?: number;
  /** Delay before triggering hover end (ms) @default 100 */
  closeDelay?: number;
  /** Cursor speed threshold (px/interval) */
  sensitivity?: number;
