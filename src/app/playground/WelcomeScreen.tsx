  ...
  return (
    ...
    >
      <StackBox direction="col" gap="6" className="max-w-md text-center">
        <BaseBox width="auto" height="auto" className="mx-auto w-16 h-16">
          <BaseImage
        ...
        <Heading level={1}>
          Welcome to{' '}
          <Span fontWeight="extrabold" className="text-red-500">
            Apple Music
          </Span>
        </Heading>

        <Paragraph className="text-gray-400 text-sm md:text-base">
          Play millions of songs and thousands of playlists ad-free on all your
          devices. Download music to listen offline. Experience sound all around
          you with Spatial Audio.
        </Paragraph>

        <StackBox direction="col" gap="2" className="text-xs text-gray-400">
          <Paragraph>
            Your searches, browsing, purchases, and device trust score help
            improve the service and prevent fraud. If you subscribe, we also use
            your music library and what you play to personalize your experience
        ...
        <StackBox direction="col" gap="4">
          <FlexBox align="center" gap="4">
            ...
            <Paragraph className="text-sm md:text-base">
              <Span fontWeight="bold">Favourite Songs Playlist:</Span> Favourite
              a song, and it will be added to your Favourite Songs Playlist.
            </Paragraph>
          </FlexBox>
          ...
          <FlexBox align="center" gap="4">
            ...
            <Paragraph className="text-sm md:text-base">
              <Span fontWeight="bold">Now in Your Library:</Span> Music you
              favourite is automatically added to your library.
            </Paragraph>
          </FlexBox>
        </StackBox>
