// src/app/playground/digit-input/components/DigitInput.tsx
'use client';
        ...
        <AnimatePresence mode="wait">
          {showError && errorMessage ? (
            <motion.p
              ...
              exit={{ opacity: 0, y: -4 }}
              className="mt-2 text-sm text-red-500 dark:text-red-400 text-center"
            >
              {errorMessage}
            </motion.p>
            ...
            <motion.p
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -4 }}
              className="mt-2 text-sm text-emerald-500 dark:text-emerald-400 text-center"
            >
              {successMessage}
            </motion.p>
          ) : helperText ? (
            <motion.p
              ...
              exit={{ opacity: 0, y: -4 }}
              className={cn(
                'mt-2 text-sm text-gray-500 dark:text-gray-400 text-center',
                disabled && 'opacity-50',
              )}
            >
              {helperText}
    ...
    >
      ...
      <AnimatePresence>
        {isFocused && !value && !disabled && (
          ...
          >
            <motion.div
              className={cn('w-0.5 rounded-full', variantStyles.caret)}
