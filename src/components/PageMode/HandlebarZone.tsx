...
export function HandlebarZone({
  ...
  switch (position) {
    case 'top':
      handlebarZoneClasses =
        'w-full h-12 flex items-center justify-center absolute bottom-0 cursor-pointer';
      handlebarLineClasses +=
        ' bg-gray-300 dark:bg-gray-500 h-3 w-16 sm:h-2 sm:w-12';
      break;
    case 'bottom':
      handlebarZoneClasses =
        'w-full h-12 flex items-center justify-center absolute top-0 cursor-pointer';
      handlebarLineClasses +=
        ' bg-gray-300 dark:bg-gray-500 h-3 w-16 sm:h-2 sm:w-12';
      break;
    case 'left':
      handlebarZoneClasses =
        'h-full w-12 flex items-center justify-center absolute right-0 cursor-pointer';
      handlebarLineClasses +=
        ' bg-gray-300 dark:bg-gray-500 w-3 h-16 sm:w-2 sm:h-12';
      break;
    case 'right':
      handlebarZoneClasses =
        'h-full w-12 flex items-center justify-center absolute left-0 cursor-pointer';
      handlebarLineClasses +=
        ' bg-gray-300 dark:bg-gray-500 w-3 h-16 sm:w-2 sm:h-12';
      break;
    default:
