...
//   useEffect(() => {
//     if (isOpen) {
//       register({ id: componentId.current, onEscape: escapeClose ? onClose : undefined });
//     }
//     return () => {
...
//   const pullDist = 10;//50; // Distance to trigger visual feedback in both directions
...
//     if (rubberBandOnDrag) {
//       // If rubberBandOnDrag is true, trigger beyond-limit if pulled more than pullDist in either direction along the axis.
...
//       }
//     } else {
//       // Original logic when rubberBandOnDrag is false (no changes needed here if you want same old behavior)
//       const threshold = 0.6;
